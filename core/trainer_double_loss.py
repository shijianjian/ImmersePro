    ...
    def _train_epoch(self, pbar):
        ...
        while train_data is not None:
            ...
            if isinstance(output, (list, tuple)) and len(output) == 2:
                pred_conversion, pred_imgs = output
                ...
                pred_conversion, pred_imgs, selection_map = output
                pred_conversion = pred_conversion.view(b, -1, c, h, w)
                pred_imgs = pred_imgs.view(b, -1, c, h, w)
            ...
            gen_loss += compute_diffloss(pred_imgs * 100, frames_right * 100)
            ...
            if not self.config['model']['no_dis']:
                ...
                gen_clip = self.netD(comp_imgs) / 2 + self.netD(pred_conversion) / 2
            ...
            if not self.config['model']['no_dis']:
                ...
                fake_clip = self.netD(comp_imgs.detach()) / 2 + self.netD(pred_conversion.detach()) / 2
