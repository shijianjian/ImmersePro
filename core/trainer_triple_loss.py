    ...
    def _train_epoch(self, pbar):
        ...
        while train_data is not None:
            ...
            try:  # DDP
                ...
                prop_imgs = self.netG.img_propagation(masked_local_frames, pred_flows_bi, interpolation=self.interp_mode)
            ...
            texture_loss = self.l1_loss(pred_texture * 100, frames_right * 100)
            ...
            if not self.config['model']['no_dis']:
                ...
                gen_clip = self.netD(comp_imgs) / 3 + self.netD(pred_conversion) / 3 + self.netD(pred_texture) / 3
            ...
            if not self.config['model']['no_dis']:
                ...
                fake_clip = self.netD(comp_imgs.detach()) / 3 + self.netD(pred_conversion.detach()) / 3 + self.netD(pred_texture.detach()) / 3
